...
var
  ...
  var
    key: Integer;
  begin
    key := Ord(ATMI^.Smoothed.HMirror) or (Ord(ATMI^.Smoothed.VMirror) shl 1) or (Ord(AFrame.PKeyFrame <> Self) shl 2) or (ATMI^.Smoothed.PalIdx shl 3);

    Result := @DCTs[ATMI^.Smoothed.TileIdx, key];
